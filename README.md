# Домашнее задание к занятию «Git - Брусенцева Злата
...
### Инструкция по выполнению домашнего задания
   ...
   7. Любые вопросы задавайте в разделе «Вопросы по заданию» в личном кабинете.
...
This is a repository for Git Zlata's homework assignment.
